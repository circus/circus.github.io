<html doctype>
	...
	<body>
		...
		<p>
			...
			As far as I know, this is <span class="hl">the only event-based parser <em>generator</em> in existence</span> (please <a href="mailto:vadim@grammarware.net">tell me</a> if I'm wrong, would be glad to hear of similar projects), even though event-based parsers like <a href="https://en.wikipedia.org/wiki/Simple_API_for_XML">SAX</a> or <a href="https://github.com/yongjhih/RxParse">RxParse</a> are not really rarities. It was designed and developed as an experiment and published at the <a href="https://2019.splashcon.org/home/rebls-2019">REBLS</a> workshop at SPLASH 2019. The <a href="https://grammarware.net/writes/index.html#Event-Based2019">PDF of the paper</a> is freely available, it contains a more detailed and precise description of the idea, some implementation details and empirical comparison of parsers. The code of <em>Engage!</em> got improved a bit further due to a successful research project of <a href="http://essay.utwente.nl/85677/">Frank Groeneveld</a>.
		</p>
