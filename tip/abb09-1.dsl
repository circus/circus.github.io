<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — ABB09-1" />
	<body>
		<credit/>
		...
		<dl><dt>Source</dt>
	<dd><a href="abborstl2009.html">AbborsTL2009</a></dd>
<dt>Categories</dt>
...
<dt>Quotes</dt>
	<dd class="red">"Ultimately, since requirements are traced to model elements, it facilitates the identification of which functionalities of SUT are not in sync with the model, and hence with the requirements."</dd>
	<dd class="red">"Traceability of requirements can help in depicting missing tests, i.e. when critical requirements are not traced to any tests."</dd>
<dt>Summary</dt>
	...
	<dd>Cause: trace links must be propagated across several modelling and testing steps; the paper notes that requirements change over the lifecycle, trace upkeep becomes tedious, and only requirements attached to state-machine transitions are currently propagated to Qtronic.</dd>
	<dd>As a result, there are missing tests and incomplete requirement coverage; failed tests can be back-traced to linked model elements; omissions and requirement misinterpretations surface early in modelling.</dd>
</dl>
<clear/>
