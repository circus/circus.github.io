<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — ARC22-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>ARC22-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"To customize this code for different operational environments, the generated code, rather than the model, is modified, leading to inconsistency between the code and the model."</dd>
	<dd class="red">"This inconsistency mainly impacts the maintainability of the code, since the models can no longer be used as accurate documentation of the implementation."</dd>
<dt>Summary</dt>
