<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — ARC22-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>ARC22-2</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="jongelingccc2022.html">JongelingCCC2022</a></dd>
<dt>Categories</dt>
	<dd><a href="c4.html">C4</a> (primary); <a href="c7.html">C7</a> (secondary)</dd>
<dt>Domain</dt>
	<dd>industrial continuous model-based development</dd>
<dt>Views</dt>
	<dd>design models</dd>
	<dd>tests</dd>
	<dd>implementation models</dd>
<dt>Artefacts</dt>
	<dd>test cases/scripts/models</dd>
	<dd>models under test</dd>
<dt>Quotes</dt>
	<dd class="red">"When tests are consistent with the design models, it is meant that not only the test cases pass, but also that the test cases appropriately cover the models, i.e., test the correct things."</dd>
	<dd class="red">"Inconsistency caused by, e.g., a drop in test coverage is much more subtle to detect than test case failure."</dd>
<dt>Summary</dt>
