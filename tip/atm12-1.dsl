<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — ATM12-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>ATM12-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="maderg2012.html">MaderG2012</a></dd>
<dt>Categories</dt>
...
<dt>Views</dt>
	...
	<dd>design models</dd>
<dt>Artefacts</dt>
	<dd>traceability relations between lifecycle artefacts</dd>
<dt>Quotes</dt>
	<dd class="red">"To ensure that the anticipated benefits […] can be realized, it is necessary to have an up-to-date set of traceability relations between the established artifacts. This goal requires the creation of traceability relations during the initial development process."</dd>
	<dd class="red">"Furthermore, the goal also requires the maintenance of traceability relations over time as the software system evolves in order to prevent their decay."</dd>
	<dd class="red">"Maintaining traceability means to prevent its decay while related artifacts evolve."</dd>
<dt>Summary</dt>
	<dd>Trace links that were once valid become stale as related artefacts evolve.</dd>
	<dd>Cause: artefact evolution without commensurate maintenance of trace links.</dd>
