...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>BC23-2</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="krauter2023.html">Krauter2023</a></dd>
<dt>Categories</dt>
	<dd><a href="c3.html">C3</a> (primary); <a href="c2.html">C2</a> (secondary)</dd>
<dt>Domain</dt>
	<dd>Behavioral multi-modeling</dd>
	<dd>traffic management</dd>
<dt>Views</dt>
	<dd>BPMN bus controller model</dd>
	<dd>UML/BPMN traffic-light/T-Junction behavior</dd>
<dt>Artefacts</dt>
	<dd>Pass Junction activity</dd>
	<dd>corresponding traffic-light states</dd>
<dt>Quotes</dt>
	<dd>"we want to check that they cannot pass when their traffic light is red or red-amber ... the Pass Junction activity should not execute while the corresponding traffic light is red or red-amber"</dd>
<dt>Summary</dt>
	<dd>The bus behavioral model allows progress that is inconsistent with the traffic-light state in the coupled controller model.</dd>
	<dd>Cause: interaction semantics between models are insufficiently constrained or incorrectly coordinated.</dd>
	<dd>As a result, behavioral safety violation during execution.</dd>
