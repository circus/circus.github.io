<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — BCM23-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>BCM23-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd><a href="https://www.omg.org/uml/" title="Unified Modelling Language">UML</a> state machine traffic-light model</dd>
