...
<dt>Quotes</dt>
	<dd class="red">"we want to check that they cannot pass when their traffic light is red or red-amber ... the Pass Junction activity should not execute while the corresponding traffic light is red or red-amber"</dd>
<dt>Summary</dt>
