<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — BCM23-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>BCM23-2</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="krauterkrls2023.html">KrauterKRLS2023</a></dd>
<dt>Categories</dt>
	<dd><a href="c3.html">C3</a> (primary); <a href="c2.html">C2</a> (secondary)</dd>
<dt>Domain</dt>
	<dd>behavioural multi-modelling</dd>
...
<dt>Quotes</dt>
	<dd class="red">"We want to check that they [busses] cannot pass when their traffic light is red or red-amber. Concretely, this means the Pass Junction activity should not execute while the corresponding traffic light is red or red-amber."</dd>
<dt>Summary</dt>
