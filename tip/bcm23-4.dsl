<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — BCM23-4" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>BCM23-4</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>interacting behavioural models in a configured multi-model</dd>
<dt>Artefacts</dt>
...
<dt>Quotes</dt>
	<dd class="red">"We face the problem that the models are not independent."</dd>
	<dd class="red">"If we were to run the models independently in parallel, the properties would be violated."</dd>
<dt>Summary</dt>
