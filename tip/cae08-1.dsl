...
<dt>Artefacts</dt>
	...
	<dd>trace links</dd>
<dt>Quotes</dt>
	<dd class="red">"A traditional obstacle in the use of multiple representations is the need to maintain traceability among the representations in the face of evolution ... relate versions of architectural elements to versions of source code configuration items"</dd>
<dt>Summary</dt>
