<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — CAE08-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>CAE08-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="murtahw2008.html">MurtaHW2008</a></dd>
<dt>Categories</dt>
	<dd><a href="c6.html">C6</a> (primary); <a href="c7.html">C7</a> (secondary)</dd>
<dt>Domain</dt>
	<dd>architecture-to-implementation traceability</dd>
<dt>Views</dt>
	<dd>software architecture</dd>
	<dd>implementation code</dd>
<dt>Artefacts</dt>
	<dd>versions of architectural elements</dd>
	<dd>versions of source code configuration items</dd>
	<dd>trace links</dd>
<dt>Quotes</dt>
	<dd class="red">"A traditional obstacle in the use of multiple representations is the need to maintain traceability among the representations in the face of evolution. […] Specifically, the task is to relate versions of architectural elements to versions of source code configuration items, and to update those relations as new versions of the architecture and source code are produced."</dd>
<dt>Summary</dt>
	<dd>Architecture-to-code links must survive concurrent version evolution on both sides.</dd>
	<dd>Cause: trace links are tied to evolving versions of both architecture and code artefacts.</dd>
