<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — CCM19-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>CCM19-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"If the system model and <a href="https://en.wikipedia.org/wiki/Simulink">Simulink</a> model assume a different total mass of the car, this inconsistency could result in an incorrect <a href="https://en.wikipedia.org/wiki/Anti-lock_braking_system" title="anti-lock braking system">ABS</a>."</dd>
<dt>Summary</dt>
