<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — DHI19-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DHI19-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="feldmann2019.html">Feldmann2019</a></dd>
<dt>Categories</dt>
	<dd><a href="c5.html">C5</a></dd>
<dt>Domain</dt>
	<dd>automated production systems</dd>
	<dd>heterogeneous engineering models</dd>
<dt>Views</dt>
	<dd>inter-model vocabulary alignment</dd>
<dt>Artefacts</dt>
	<dd>properties across linked models</dd>
<dt>Quotes</dt>
	<dd class="red">"Naming inconsistency for elements (common vocabulary)"</dd>
	<dd class="red">"Naming inconsistency for properties (common vocabulary)"</dd>
	<dd class="red">"Naming inconsistency for elements (mechatronics vocabulary)"</dd>
	<dd class="red">"Naming inconsistency for properties (mechatronics vocabulary)"</dd>
<dt>Summary</dt>
