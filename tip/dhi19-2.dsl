<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — DHI19-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DHI19-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Domain</dt>
	...
	<dd>electrics models</dd>
<dt>Views</dt>
	<dd>inter- and intra-model electrical interface descriptions</dd>
<dt>Artefacts</dt>
	<dd>connectors</dd>
