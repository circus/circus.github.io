<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — DHI19-3" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DHI19-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Domain</dt>
	...
	<dd>project + discipline models</dd>
<dt>Views</dt>
	<dd>project documentation</dd>
	<dd>discipline-specific model</dd>
<dt>Artefacts</dt>
	<dd>documentation item</dd>
	<dd>refined common/model element</dd>
	<dd>refinement link</dd>
<dt>Quotes</dt>
	<dd class="red">"Inconsistency for refinement between project documentation and discipline-specific model."</dd>
<dt>Summary</dt>
	<dd>A documentation artefact does not properly refine or correspond to the intended discipline-specific model element.</dd>
	<dd>Cause: refinement relation is ill-formed or points to a mismatched artefact.</dd>
