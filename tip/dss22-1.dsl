<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — DSS22-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DSS22-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="jongelingfccc2022.html">JongelingFCCC2022</a></dd>
<dt>Categories</dt>
	<dd><a href="c1.html">C1</a> (primary); <a href="c6.html">C6</a> (secondary)</dd>
<dt>Domain</dt>
...
<dt>Quotes</dt>
	<dd class="red">"According to domain experts, the top-level code components should be <a href="https://git-scm.com/">Git</a> repositories, and hence each system component in the model […] should be matched to a <a href="https://git-scm.com/">Git</a> repository."</dd>
	<dd class="red">"Soon, exceptions to this rule appeared, because in some cases multiple system components were included in a single repository."</dd>
<dt>Summary</dt>
