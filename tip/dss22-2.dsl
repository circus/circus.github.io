<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — DSS22-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DSS22-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"Now, things are improved in the code and then forgotten about. Then six months later, you see that the model is not at all updated. So some reminder is needed to show that the model is not correct anymore."</dd>
<dt>Summary</dt>
