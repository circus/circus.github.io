<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — DSS22-3" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>DSS22-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"this puts a requirement on following a specific naming convention. Not everybody does this"</dd>
<dt>Summary</dt>
