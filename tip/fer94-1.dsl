<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — FER94-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>FER94-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"For each agent in the agent hierarchy there must be one ViewPoint instantiated from a TC template"</dd>
<dt>Summary</dt>
