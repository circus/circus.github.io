<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — FER94-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>FER94-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Artefacts</dt>
	<dd>source/destination entry in tabular collection diagram</dd>
...
<dt>Quotes</dt>
	...
	<dd class="red">"Two Viewpoints may be partially overlapping, with a partial specification in one related to a partial specification in the other."</dd>
	<dd class="red">"For example, CORE requires that a source agent in a tabular collection diagram is a named agent in the agent hierarchy."</dd>
<dt>Summary</dt>
