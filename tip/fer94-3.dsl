<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — FER94-3" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>FER94-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"The Output produced by one agent in a tabular collection diagram must be consumed as an Input in the tabular collection diagram [by] another agent"</dd>
<dt>Summary</dt>
