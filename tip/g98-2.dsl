...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>G98-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Summary</dt>
	...
	<dd>Refinement/correspondence relation exists, but automatic propagation is unavailable because the mapping to implementation details is underdetermined.</dd>
	<dd>Implementation no longer reflects the design; manual repair is required.</dd>
