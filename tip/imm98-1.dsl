<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — IMM98-1" />
	<body>
		<credit/>
		<h1>
...
<dt>Quotes</dt>
	<dd>"renaming a class in an OO design view means all other analysis, design, implementation and documentation views become inconsistent unless the class name is changed in these views"</dd>
<dt>Summary</dt>
