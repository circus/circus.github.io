<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — IMM98-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>IMM98-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="grundyhm1998.html">GrundyHM1998</a></dd>
<dt>Categories</dt>
...
<dt>Artefacts</dt>
	...
	<dd>derived code</dd>
	<dd>documentation artefacts</dd>
<dt>Quotes</dt>
	<dd class="red">"Inconsistency detection is needed after one view is edited in order to detect: structural inconsistencies between views (e.g., class attributes added in one view aren’t in another); […]."</dd>
	<dd class="red">"Renaming a class in an OO design view means all other analysis, design, implementation and documentation views become inconsistent unless the class name is changed in these views."</dd>
<dt>Summary</dt>
	<dd>A class is renamed in one design view, but the corresponding name is not propagated to related views and artefacts.</dd>
	...
	<dd>As a result, cross-view disagreement; developers may overlook the inconsistency; downstream artefacts no longer refer to the same concept consistently.</dd>
</dl>
<clear/>
