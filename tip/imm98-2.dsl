<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — IMM98-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>IMM98-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>OO design view</dd>
	<dd>textual code view(s)</dd>
<dt>Artefacts</dt>
	<dd>method call connection in design model</dd>
	<dd>affected textual code views</dd>
<dt>Quotes</dt>
	<dd class="red">"Adding a method call connection in an OO design view cannot be automatically added to the appropriate textual code view(s) affected by this change, so the code views become inconsistent."</dd>
<dt>Summary</dt>
