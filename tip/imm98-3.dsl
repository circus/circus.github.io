<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — IMM98-3" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>IMM98-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Artefacts</dt>
	...
	<dd>class methods</dd>
<dt>Quotes</dt>
	<dd class="red">"Inconsistency detection is needed after one view is edited in order to detect: […] semantic inconsistencies in specifications (e.g., a type mismatch between method calls or a nonexistent method is called); […]."</dd>
<dt>Summary</dt>
	<dd>Two related artefacts agree enough to connect, but disagree on call signature or method existence.</dd>
