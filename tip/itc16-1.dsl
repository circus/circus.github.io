<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — ITC16-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>ITC16-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="demuthkem2016.html">DemuthKEM2016</a></dd>
<dt>Categories</dt>
...
<dt>Quotes</dt>
	<dd class="red">"We discuss experiences […] in maintaining the consistency between electrical models and the corresponding software controller when both are subject to continuous change."</dd>
<dt>Summary</dt>
