...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>J19-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>High-level SysML diagrams</dd>
	<dd>lower-level Simulink model</dd>
<dt>Artefacts</dt>
...
<dt>Summary</dt>
	...
	<dd>Evolution of the abstract model without co-evolution of the lower-level model.</dd>
	<dd>Incorrect implementation of the affected function; need to tolerate temporarily but eventually repair.</dd>
