...
<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — J22-3" />
	<body>
		<credit/>
		<h1>
			...
			<br><span class="red">Case</span> <code>J22-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>High-level system/architecture models</dd>
	<dd>implementation</dd>
<dt>Artefacts</dt>
	<dd>System models</dd>
	<dd>implementation artifacts</dd>
	<dd>feedback links</dd>
<dt>Quotes</dt>
	<dd>"It is accepted by engineers that the models are not fully consistent with the eventual implementation ... Nevertheless, it is required that the eventual implementation conforms to the requirements. In the current setting, there is no feedback loop between the model and implementation"</dd>
<dt>Summary</dt>
	...
	<dd>Asynchronous development and missing feedback loop between abstraction levels.</dd>
	<dd>Implementation may drift from the intended design and engineers lose model-based overview.</dd>
