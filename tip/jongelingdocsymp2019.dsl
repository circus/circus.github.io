<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — JongelingDocSymp2019" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Source</span> <code>JongelingDocSymp2019</code>
		</h1>
		<p></p>
<pre>[kw1]@inproceedings[/]{JongelingDocSymp2019,
