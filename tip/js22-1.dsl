...
<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — JS22-1" />
	<body>
		<credit/>
		<h1>
			...
			<br><span class="red">Case</span> <code>JS22-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd>"each system component in the model ... should be matched to a Git repository. Soon, exceptions to this rule appeared, because in some cases multiple system components were included in a single repository"</dd>
<dt>Summary</dt>
	<dd>The intended one-to-one mapping between model components and code containers fails in practice.</dd>
	<dd>Real code organization does not obey the assumed architectural correspondence rule.</dd>
	<dd>Initial consistency rule is invalid or too rigid; matching heuristic and rule must be revised.</dd>
