<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — macros" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Artefact</span> <code>macros</code>
		</h1>
		<p>Download raw LaTeX: <a href="macros.tex">macros.tex</a></p>
