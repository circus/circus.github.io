<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — MBT12-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>MBT12-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="georgefhkba2012.html">GeorgeFHKBA2012</a></dd>
<dt>Categories</dt>
...
<dt>Quotes</dt>
	<dd class="red">"Relationships between the different models will help to navigate from one model to another, and trace back to the respective requirements and the design model when the test fails"</dd>
<dt>Summary</dt>
