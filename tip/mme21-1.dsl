...
<dt>Quotes</dt>
	<dd class="red">"Every method, which realizes a requirement must have an associated test case and for every mandatory requirement there has to be at least one test case."</dd>
<dt>Summary</dt>
