<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — MME21-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>MME21-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="stunkelkrl2021.html">StunkelKRL2021</a></dd>
<dt>Categories</dt>
...
<dt>Quotes</dt>
	<dd class="red">"Every method, which realizes a requirement must have an associated test case and for every mandatory requirement there has to be at least one test case ... assume that a new mandatory requirement is added to M1. This obviously invalidates CR-1 since there is no unit test for the new requirement."</dd>
<dt>Summary</dt>
