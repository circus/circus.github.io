...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>MUR08-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="murta2008.html">Murta2008</a></dd>
<dt>Categories</dt>
...
<dt>Artefacts</dt>
	...
	<dd>trace links</dd>
<dt>Quotes</dt>
	<dd>"A traditional obstacle in the use of multiple representations is the need to maintain traceability among the representations in the face of evolution ... relate versions of architectural elements to versions of source code configuration items"</dd>
<dt>Summary</dt>
	...
	<dd>As a result, without continuous evolution of traces, architecture and implementation lose synchronization.</dd>
