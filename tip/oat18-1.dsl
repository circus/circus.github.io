<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — OAT18-1" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>OAT18-1</code>
		</h1>
		<dl><dt>Source</dt>
	<dd><a href="javedmz2018.html">JavedMZ2018</a></dd>
<dt>Categories</dt>
...
<dt>Views</dt>
	...
	<dd>traceability links between artefacts</dd>
<dt>Artefacts</dt>
	<dd>existing trace links across versions/releases</dd>
<dt>Quotes</dt>
	<dd class="red">"After the painstaking process of traceability construction, a substantial evolution of a software system, such as a new major version leads to the decay of traceability links."</dd>
<dt>Summary</dt>
