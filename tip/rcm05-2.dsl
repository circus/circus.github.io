<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — RCM05-2" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>RCM05-2</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"The state machine of A belongs to a higher-level model, it is nondeterministic and also models the case where the file to be opened is non-existent. […] In C the nondeterminism has been resolved, possibly by ensuring applicability of open on existing files only."</dd>
	<dd class="red">"Is every behaviour of C a behaviour of A?"</dd>
<dt>Summary</dt>
