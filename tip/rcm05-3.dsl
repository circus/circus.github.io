<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — RCM05-3" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>RCM05-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"While class A contains a single operation send, class C uses two operations for one send, the first one being responsible for preparing the message for sending […] and the second one for actual transmission."</dd>
