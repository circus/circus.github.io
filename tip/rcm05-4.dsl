<html doctype>
	<head title="Taxonomy of Inconsistency Patterns — RCM05-4" />
	<body>
		<credit/>
		<h1 logo="tip.200.png" alt="TIP" hover="TIP logo designed by Vadim Zaytsev">
			...
			<br><span class="red">Case</span> <code>RCM05-4</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Quotes</dt>
	<dd class="red">"Sending is split into preparation and transmission. […] After a trace of C in which prepare has occured but transmit not, transmit may not be refused. There are no traces in C in which transmit occurs without a prior prepare."</dd>
	<dd class="red">"Has every behaviour of C a corresponding behaviour in A?"</dd>
<dt>Summary</dt>
