...
<dt>Quotes</dt>
	<dd class="red">"Again sending is split into preparation and transmission... Continuation: after a trace of C in which prepare has occured but transmit not, transmit may not be refused; Proper starting: There are no traces in C in which transmit occurs without a prior prepare."</dd>
<dt>Summary</dt>
