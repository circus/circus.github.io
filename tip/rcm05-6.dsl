<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — RCM05-6" />
	<body>
		<credit/>
		<h1>
			...
			<br><span class="red">Case</span> <code>RCM05-6</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>behaviour model A</dd>
	<dd>extended behaviour model C</dd>
<dt>Artefacts</dt>
