...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>W05-1</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Summary</dt>
	...
	<dd>A data-type transformation changes the semantics of state and operations across refinement levels.</dd>
	<dd>The refined model may preserve representation but alter observable behavior unless a valid refinement relation is established.</dd>
