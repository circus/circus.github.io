...
<dt>Summary</dt>
	...
	<dd>Protocol refinement tightens behavioral assumptions relative to the abstract view.</dd>
	<dd>Behavioral possibilities differ across abstraction levels; refinement must be checked to ensure the lower-level behavior is still permitted by the higher-level one.</dd>
