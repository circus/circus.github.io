...
<html doctype>
	<head jquery title="Taxonomy of Inconsistency Patterns — W05-3" />
	<body>
		<credit/>
		<h1>
			...
			<br><span class="red">Case</span> <code>W05-3</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Summary</dt>
	...
	<dd>An operation is decomposed into a sequence of lower-level steps, introducing the risk of intermediate states and new execution paths.</dd>
	<dd>The refined model can admit behaviors not present in the abstract one unless continuation and proper-starting conditions are enforced.</dd>
