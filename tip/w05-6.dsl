...
<dt>Summary</dt>
	...
	<dd>Behavioral extension introduces new transitions running alongside the original protocol.</dd>
	<dd>Consistency depends on substitutivity: the extended model must preserve the old behavior under interleaving with the new action.</dd>
