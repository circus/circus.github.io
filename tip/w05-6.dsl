...
<html doctype>
	...
	<body>
		...
		<h1>
			...
			<br><span class="red">Case</span> <code>W05-6</code>
		</h1>
		<dl><dt>Source</dt>
...
<dt>Views</dt>
	<dd>Behavior model A</dd>
	<dd>extended behavior model C</dd>
<dt>Artefacts</dt>
	<dd>Original put/get protocol</dd>
	<dd>added parallel full transition</dd>
<dt>Quotes</dt>
	<dd>"A state machine is extended with a parallel component independently executing the method full... execution of full in C may not interfere with the ‘old’ behaviour modelled in A."</dd>
<dt>Summary</dt>
	<dd>A dynamic model is extended with a parallel full action that must remain non-interfering with the existing put/get behavior.</dd>
	<dd>Cause: behavioral extension introduces new transitions running alongside the original protocol.</dd>
	<dd>As a result, consistency depends on substitutivity: the extended model must preserve the old behavior under interleaving with the new action.</dd>
